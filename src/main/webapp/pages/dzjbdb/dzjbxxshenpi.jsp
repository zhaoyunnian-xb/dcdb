...
<script>
  $(function () {
    ...
    var form = layui.form;
      ...
      $('#returnBtn').on('click', function () {
          ...
          var ymlx = $("#ymlx").val()
          if (ymlx == 'db'){
              window.location.href = '/db/index.do?lclx=dzjb&currentPage=' + currentPage;
          } else if (ymlx == 'yb'){
              window.location.href = '/yb/index.do?lclx=dzjb&currentPage=' + currentPage;
          } else if (ymlx == 'bj'){
              window.location.href = '/db/gdIndex.do?lclx=dzjb&currentPage=' + currentPage;
          }
      })
      // 引入treeTable 插件
      layui.config({
  ...
  function tsxx() {
      var nodeid = $("#nodeidyc").val();
      var ywtype = $("#lclxyc").val();
      $.ajax({
          url: "/flow/tsxx.do",
          type: "post",
          async: false,
          data: {"nodeId": nodeid, "lctype": ywtype, "sftg": "1"},
          dataType: "json",
