 ...
 联系人：*****     联系电话：*****
                                    ...
                                    <div class="layui-colla-item">
                                        ...
                                        <div class="layui-colla-content layui-show">
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">审批人：</label>
                                                <div class="layui-input-block">
                                                    <input type="text" name="yldfzrmc" id="yldfzrmc" required lay-verify="required"
                                            ...
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">审批日期 ：</label>
                                                <div class="layui-input-block">
                                                    <input type="text" name="yldsprq" id="yldsprq" required lay-verify="required"
                                                           placeholder="" autocomplete="off" class="layui-input">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">审批意见 ：</label>
                                                <div class="layui-input-block">
                                                    <input type="text" name="yldspyj" id="yldspyj" required lay-verify="required"
                                                           placeholder="" autocomplete="off" class="layui-input">
                                                </div>
                                            </div>
                                            <div class="layui-form-item layui-form-text">
                                                <label class="layui-form-label">审批备注 ：</label>
                                                <div class="layui-input-block">
                                                    <textarea name="yldspbz" id="yldspbz" placeholder=""
                        ...
                        <div class="layui-col-md12">
                            <div class="btn-wrapper " id="czspan">
                                ...
                                <div class="layui-col-md4 layui-col-md-offset1">
                                   <%-- <span class="layui-btn layui-btn-primary" id="yulan">导出预览</span>--%>
                                    <span class="layui-btn layui-btn-normal" id="submitFlow">提交</span>
                                    <span class="layui-btn layui-btn-primary" id="rebackFlow">退回</span>
                                </div>
                            </div>
                        </div>
                    </div>
