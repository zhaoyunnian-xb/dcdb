                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-sm6 layui-col-md8 ">
                        <div class="layui-form-item" style="text-align: right;">
                            <span class="layui-btn layui-btn-normal" onclick="zyjcdbQuery();">检索</span>
                            <c:if test="${name=='罗艳'}">
                                <span class="layui-btn layui-btn-primary" onclick="zyjcxinjian();">创建</span>
                            </c:if>
                        </div>
                    </div>
                </div>
    ...
    function zyjcdbQuery() {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'lxmc', align: 'center', title: '立项名称',event:'psjmc',  minWidth: 120,
                    style:'color:blue;cursor:pointer'},
              {field: 'nodeName', align: 'center', title: '节点名称', minWidth: 120},
