                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <select name="bllx" lay-verify="required" id="bllx" lay-filter='bllx'>
                                                    ...
                                                    <option value="省院交办" selected>省院交办</option>
                                    ...
                                    <div class="layui-col-md6">
                                     ...
                                     <div class="layui-col-md6">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" name="dcsx" id="dcsx" class="layui-input" value=""/>
                                            </div>
                                        </div>
                                    </div> 
                                   <!--  <div class="layui-col-md6">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" name="dcyy" id="dcyy" class="layui-input" value=""/>
                                            </div>
                                        </div>
                                    </div> -->
                                     <div class="layui-col-md6">
                                        <div class="layui-form-item">
                                            <label class="layui-form-label">督查缘由：</label>
                                            <div class="layui-input-block ">
                                                <select name="dcyy" lay-verify="required" id="dcyy" lay-filter='dcyy'>
                                                    <option value="">请选择</option>
                                                    <option value="最高检">最高检</option>
...
<script type="text/javascript" src="${ctx}/common/js/dcdb/dcdbFlowJbsx.js" charset='utf-8' language="javascript"></script>
<script type="text/javascript" src="${ctx}/common/js/dcdb/common.js" charset='utf-8' language="javascript"></script>
<script type="text/javascript" src="${ctx}/common/js/dcdb/jbsxxx.js" charset='utf-8' language="javascript"></script>
<script>
    $(function () {
      //提交
