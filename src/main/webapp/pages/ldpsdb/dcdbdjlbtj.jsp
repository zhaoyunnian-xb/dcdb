    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
                ...
                <div class="layui-row layui-col-space10">
                    ...
                    <div class="layui-col-sm6 layui-col-md3">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select name="lczt" id = "lczt"lay-verify="required" lay-search>
                                    <option value="">请选择</option>
            ...
            <div class="table-wrapper">
                <table class="layui-table" id="djlb_tj" lay-filter="djlb_tj" ></table>
            </div>
        </div>
...
<script>
    ...
    function tjQuery() {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'zt', align: 'center', title: '状态', width: 80},
    ...
    layui.use('table', function () {
        table.on('tool(djlb_tj)', function (obj) {
            var data = obj.data;
            if (obj.event === 'psjmc') {
