        ...
        <div class="layui-card-body">
            <div class="layui-form">
                <div class="layui-row layui-col-space10">
                    ...
                    <div class="layui-col-sm6 layui-col-md3">
                        <div class="layui-form-item">
                            <label class="layui-form-label" id="swrqLab">收文日期：</label>
                            <div class="layui-input-block">
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-sm6 layui-col-md3">
                        <div class="layui-form-item">
                            <label class="layui-form-label" id="pslxLab">批示类型 ：</label>
                            <div class="layui-input-block">
                    ...
                    <div class="layui-col-sm6 layui-col-md3" id="psrqDiv">
                        <div class="layui-form-item">
                    ...
                    <div class="layui-row ">
                        <div class="layui-form-item" style="margin-left: 38px;text-align: right">
                            <span class="layui-btn layui-btn-normal" onclick="dbQuery();">检索</span>
                            <c:if test="${name=='罗艳' || name == '孙业鹏'}">
...
<script>
    ...
    function dbQuery() {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'psjmc', align: 'center', title: '被批示件名称',event:'psjmc',  minWidth: 200,
                ...
                {field: 'nodeName', align: 'center', title: '节点名称',hide: "true"},
    ...
    layui.use('table', function () {
        table.on('tool(djlb_db)', function (obj) {
            var data = obj.data;
            if (obj.event === 'psjmc') {
                if(data.nodeId == '0101'||data.nodeId == ''){
                    window.location.href = encodeURI('${ctx}/db/toxinjian.do?isReadOnly=0&id='+data.id+'&wh='+data.wh+'&bllx='+data.bllx
                        +'&nodeid='+data.nodeId+'&nodename='+data.nodeName+'&cjr='+data.cjr+'&cbbmid='+data.cbbmid+'&cbbmmc='+data.cbbmmc+'&lclx='+data.lclx+'&isfa='+data.isfaz+'&sfth='+data.sfth);
                }else {
                    window.location.href = encodeURI('${ctx}/db/toshenhe.do?isReadOnly=0&id='+data.id+'&wh='+data.wh+'&bllx='+data.bllx
                        +'&nodeid='+data.nodeId+'&nodename='+data.nodeName+'&cjr='+data.cjr+'&cbbmid='+data.cbbmid+'&cbbmmc='+data.cbbmmc+'&lclx='+data.lclx+'&isfa='+data.isfa+'&ymlx=db');
                }
            }
        });
    });
    ...
    function xinjian() {
        var lclx = $("#lclx").val();
        window.location.href = '${ctx}/db/toxinjian.do?isReadOnly=0&lclx='+lclx;
    }
    //批示类型下拉框赋值
