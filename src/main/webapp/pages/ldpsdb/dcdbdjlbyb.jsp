    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <div class="layui-form">
                ...
                <%--<div class="layui-col-sm6 layui-col-md1 layui-col-md-offset11">--%>
                <%--<div class="layui-form-item">--%>
                <%--<span class="layui-btn" onclick="ybQuery();">检索</span>--%>
                <%--</div>--%>
...
<script>
    ...
    function ybQuery() {
        ...
        table.render({
            ...
            // page: true, //开启分页
            page: {
                layout:['prev','page','next','skip', 'count','skip'],
                curr: currentPage || 1
            },
            ...
            cols: [[
                ...
                {field: 'nodeName', align: 'center', title: '节点名称',hide: false, width: 80},
    ...
    layui.use('table', function () {
        table.on('tool(djlb_yb)', function (obj) {
            ...
            if (obj.event === 'psjmc') {
                ...
                +'&nodeid='+data.nodeId+'&nodename='+data.nodeName+'&cjr='+data.cjr+'&cbbmid='+data.cbbmid+'&lclx='+data.lclx+'&currentPage='+currentPage+'&ymlx=yb');
            }
        });
    });
    //查询部门下拉列表
