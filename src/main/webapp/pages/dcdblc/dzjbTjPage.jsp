                ...
                if (obj.event == 'caseDetal') {//caseDetal:cols中 evet属性值
                    table.render({
                        ...
                        cols: [[
                            ...
                            {field: 'swrq', align: 'center', title: '收文日期',width:100},
                            {field: 'zxdbh', align: 'center', title: '督办单号',event:"caseDetail",templet:function(d){
                                var html = '';
                                return html = '<a style="color:#1b9cff;cursor:pointer;">'+d.zxdbh+'</a>';
                                }},
                            {field: 'blqk', align: 'center', title: '办理情况'}
                        ]]
                    });
