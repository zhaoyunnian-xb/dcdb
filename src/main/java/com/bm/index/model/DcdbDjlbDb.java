...
public class DcdbDjlbDb {
    ...
    private String yjqk;//预警情况

    private String lzsj;

    private String preid;

    private String pslx; //批示类型

    private String issjldpsj; //是否省院上级领导批示件
    ...
    public String getIssjldpsj() {
        return issjldpsj;
    }

    public void setIssjldpsj(String issjldpsj) {
        this.issjldpsj = issjldpsj;
    }
    ...
    public void setCbbmmc(String cbbmmc) {
        this.cbbmmc = cbbmmc == null ? null : cbbmmc.trim();
    }
    ...
    public void setCbbmid(String cbbmid) {
        this.cbbmid = cbbmid == null ? null : cbbmid.trim();
    }
